...
const translations: Record<string, Record<string, string>> = {
  es: {
    ...
    'hero.subtitle': 'Remodelamos espacios para crear el hogar que siempre soñaste. Con más de 30 años transformando casas en experiencias únicas.',
  ...
  en: {
    ...
    'hero.subtitle': 'We remodel spaces to create the home you\'ve always dreamed of. With over 30 years transforming houses into unique experiences.',
    ...
    'about.subtitle': 'Since 1994, Luxury Services has been synonymous with excellence in home remodeling in Miami and surrounding areas. Our team of craftsmen, designers, and project managers works with passion to turn every vision into a reality that exceeds expectations.',
    ...
    'footer.email': 'luxuryservicesfl@gmail.com',
    'footer.address': 'Central Florida',
    'footer.copyright': '© 2024 Luxury Services. All rights reserved.',
    'lang.es': 'ES',
    'lang.en': 'EN',
  },
};
